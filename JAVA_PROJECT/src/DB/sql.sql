...
CREATE TABLE TRANS_INFO(
                TRANS_SERV_NUM NUMBER(20) PRIMARY KEY, 
                TRANS_TYPE VARCHAR2(20),
...
VALUES(TRANS_SEQ.nextval,'Trans2','t1','L1','L2','2020/01/01 12:00:00','2020/01/01 15:30:00','ITX',10,1000);
-- 서울->대구
INSERT INTO TRANS_INFO
VALUES(TRANS_SEQ.nextval,'Trans2','t2','L1','L3','2020/01/01 12:00:00','2020/01/01 13:30:00','ITX',10,1000);
-- 서울->광주
INSERT INTO TRANS_INFO
VALUES(TRANS_SEQ.nextval,'Trans2','t3','L1','L4','2020/01/01 12:00:00','2020/01/01 15:30:00','ITX',10,1000);
                            
-- 버스 운행 테이블
-- 서울->광주
INSERT INTO TRANS_INFO
VALUES(TRANS_SEQ.nextval,'Trans1','B1','L1','L2','2020/01/01 12:00:00','2020/01/01 15:30:00','ITX',10,1000);
-- 서울->대구
INSERT INTO TRANS_INFO
VALUES(TRANS_SEQ.nextval,'Trans1','B2','L1','L3','2020/01/01 12:00:00','2020/01/01 13:30:00','ITX',10,1000);
-- 서울->광주
INSERT INTO TRANS_INFO
VALUES(TRANS_SEQ.nextval,'Trans1','B3','L1','L4','2020/01/01 12:00:00','2020/01/01 15:30:00','ITX',10,1000);


-- 예매 현황 데이터 삽입
-- 샘플 데이터
INSERT INTO BOOK
VALUES('booking0','TEST1','L1','L2',1,'2020/01/01 12:00:00','2020/01/01 15:30:00',1,1000,sysdate);
