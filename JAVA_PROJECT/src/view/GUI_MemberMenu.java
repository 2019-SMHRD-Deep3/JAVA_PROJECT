...
public class GUI_MemberMenu {
	...
	private void initialize(Member loginUser) {
		...
		panel_1.setBounds(453, 442, 147, 45);
		panel.add(panel_1);
		...
		panel_2.setBounds(624, 442, 147, 45);
		panel.add(panel_2);
		...
		panel_3.setBounds(341, 59, 521, 373);
		panel.add(panel_3);
		...
		lblName.setBounds(241, 58, 207, 24);
		panel_3.add(lblName);
		...
		lblBirth.setBounds(241, 137, 207, 24);
		...
		lblTel.setBounds(241, 216, 207, 24);
		panel_3.add(lblTel);
		...
		lblMail.setBounds(241, 297, 207, 24);
		panel_3.add(lblMail);
		...
		btnNewButton_2.setBounds(12, 89, 192, 325);
